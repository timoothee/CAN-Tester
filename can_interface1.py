...
class CANInterface():
    ...
    def build(self):
        ...
        self.listbox = Listbox(self.can_frame3, yscrollcommand = 1, width = 60, selectmode=EXTENDED)
        self.listbox1 = Listbox(self.can_frame5, yscrollcommand = 1, width = 60, selectmode =MULTIPLE)
        ...
        self.fd_CkBt = Checkbutton(self.can_frame2, variable=self.fd_box)
        ...
        self.payload_size_Entry = Entry(self.can_frame2, textvariable=self.payload_size_entry, width= 5)
        ...
        self.listbox.grid(row=0, column=0, padx=20, pady=(20,10))
        ...
        self.clear_button = Button(self.can_frame4, text="Clear", command = lambda: self.delete_function(self.listbox))
        self.clear_button.grid(row=0, column=2)

        self.listbox1.grid(row=0, column=0, padx=20, pady=(40,10))
        ...
        self.clear_button1 = Button(self.can_frame6, text="Clear", command = lambda: self.delete_function(self.listbox1))
    ...
    def check_all_fields(self):
        ...
        if self.ext_box.get() == 1:
            if int(self.frame_id_entry.get(), 16) < 255:
    ...
    def clear_text(self):
        ...
        if self.box_retVal:
            ...
            self.fd_box.set(0)
            self.ext_box.set(0)
            self.listbox.insert(self.position, self.string)
